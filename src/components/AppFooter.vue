...
<template>
  <footer class="border-t border-border bg-surface">
    <div class="container-page grid gap-12 py-16 md:grid-cols-12">
      ...
      <div class="md:col-span-4">
        ...
        <ul class="mt-4 space-y-3 text-sm">
          <li>
            <RouterLink to="/" class="text-fg hover:underline">Home</RouterLink>
          </li>
          <li>
            <a :href="`mailto:${site.contact.email}`" class="text-fg hover:underline">Contact</a>
          </li>
          <li>
            <a
        ...
        <ul class="mt-4 space-y-3 text-sm">
          <li>
            <a
              ...
              target="_blank"
              rel="noopener"
              class="inline-flex items-center gap-2 text-fg hover:underline"
            >
    ...
    <div class="border-t border-border">
      <div
        class="container-page flex flex-col items-start justify-between gap-2 py-6 text-xs text-muted md:flex-row md:items-center"
      >
        <p>© {{ year }} Numstore</p>
