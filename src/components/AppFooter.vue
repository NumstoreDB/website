...
const githubUrl = `https://github.com/${site.github.owner}/${site.github.repo}`
const youtubeUrl = `https://www.youtube.com/${site.youtube.handle}`
</script>
  ...
  <footer class="border-t border-border bg-surface">
    <div class="container-page grid gap-12 py-16 md:grid-cols-12">
      <div class="md:col-span-5">
        <div class="flex items-center gap-2 font-display text-lg font-bold">
          <svg viewBox="0 0 32 32" class="h-7 w-7" aria-hidden="true">
            ...
            <path d="M9 22V10l14 12V10" stroke="#f59e0b" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
          {{ site.name }}
        </div>
      ...
      <div class="md:col-span-4">
        <h4 class="text-xs font-semibold uppercase tracking-widest text-muted">Site</h4>
        <ul class="mt-4 space-y-3 text-sm">
          <li>
            <RouterLink to="/" class="text-fg hover:text-accent">Home</RouterLink>
          </li>
          <li>
            <RouterLink to="/about" class="text-fg hover:text-accent">About</RouterLink>
          </li>
          <li>
            <RouterLink to="/contact" class="text-fg hover:text-accent">Contact</RouterLink>
          </li>
          <li>
            <a :href="site.external.docs" target="_blank" rel="noopener" class="text-fg hover:text-accent">
              Documentation ↗
            </a>
          </li>
          <li>
            <a :href="site.external.blog" target="_blank" rel="noopener" class="text-fg hover:text-accent">
              Blog ↗
            </a>
          </li>
        </ul>
      ...
      <div class="md:col-span-3">
        <h4 class="text-xs font-semibold uppercase tracking-widest text-muted">Connect</h4>
        <ul class="mt-4 space-y-3 text-sm">
          <li>
            <a :href="githubUrl" target="_blank" rel="noopener" class="inline-flex items-center gap-2 text-fg hover:text-accent">
          ...
          <li>
            <a :href="site.linkedin" target="_blank" rel="noopener" class="inline-flex items-center gap-2 text-fg hover:text-accent">
              <svg viewBox="0 0 24 24" class="h-4 w-4" fill="currentColor" aria-hidden="true">
          ...
          <li>
            <a :href="youtubeUrl" target="_blank" rel="noopener" class="inline-flex items-center gap-2 text-fg hover:text-accent">
              <svg viewBox="0 0 24 24" class="h-4 w-4" fill="currentColor" aria-hidden="true">
          ...
          <li>
            <RouterLink to="/contact" class="inline-flex items-center gap-2 text-fg hover:text-accent">
